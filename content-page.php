...
<?php
	if( $the_query->have_posts() ):
?>
<section id="depoimento" class="depoimentos_int s7" role="main">
	<div class="content_depoimentos" style="background-image: url(<?php echo $post_thumbnail_url ?>);">
		<div class="container">
			<div class="row">
				<h1><?php echo $descCategory ;?></h1>
...
<?php
	...
	$youtube 			= $odin_general_opts['youtube_input'];
	$prezi				= $odin_general_opts['prezi_input'];
	$foursquare			= $odin_general_opts['four_input'];
	$g_plus				= $odin_general_opts['gplus_input'];
	$linkdIn			= $odin_general_opts['link_input'];
	...
	if( !empty( $inscrevaPost ) ):
?>
<section id="contato" class="inscreva_int s8" role="main">
	<div class="content content_inscreva" style="background-image: url(<?php echo $bgInscreva ?>);">
		<div class="container">
			<div class="row">
				<h1 class="col-md-12 desc_inscreva"><?php echo $titleInscreva ;?></h1>
				...
				<footer class="col-md-12">
					...
					<div class="social_footer">
						<ul>
							<?php if (!empty($facebook)) { echo '<li class="icon_face"><a href="'.$facebook.'" title="Facebook">','</a></li>';} ?>
							<?php if (!empty($youtube)) { echo '<li class="icon_youtube"><a href="'.$youtube.'" title="Youtube">','</a></li>' ;} ?>
							<?php if (!empty($prezi)) { echo '<li class="icon_prezi"><a href="'.$prezi.'" title="Prezi">','</a></li>' ;} ?>
							<?php if (!empty($foursquare)) { echo '<li class="icon_four"><a href="'.$foursquare.'" title="Foursquare">','</a></li>' ;} ?>
							<?php if (!empty($g_plus)) { echo '<li class="icon_gplus"><a href="'.$g_plus.'" title="Google Plus">','</a></li>' ;} ?>
							<?php if (!empty($linkdIn)) { echo '<li class="icon_linkin"><a href="'.$linkdIn.'" title="LinkdIn">','</a></li>' ;} ?>
							<?php if (!empty($twitter)) { echo '<li class="icon_twitter"><a href="'.$twitter.'" title="Twitter">','</a></li>' ;} ?>
						</ul>
					</div>
				</footer>
			</div>
